...
var TutorialConfig = (function (_super) {
    ...
    TutorialConfig.prototype.shouldComponentUpdate = function (t) {
        var textInputIsActive = (document.activeElement &&
    ...
    TutorialConfig.prototype.onSubmit = function (values) {
        ...
        setTimeout(function () { return _this.props.submitting = false; }, 300);
