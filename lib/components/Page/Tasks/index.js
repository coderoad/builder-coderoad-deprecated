...
var Tasks = (function (_super) {
    ...
    Tasks.prototype.render = function () {
        ...
        return (React.createElement("div", null, 
            tasks.map(function (task, index) { return (React.createElement(Card_1.Card, {key: index, style: styles.card, initiallyExpanded: index === 0}, 
            ...
            React.createElement(AddButton_1.default, {callback: tutorialTaskAdd})));
    };
    Tasks = __decorate([
