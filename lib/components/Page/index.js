...
var Page = (function (_super) {
    ...
    Page.prototype.render = function () {
        return (React.createElement("section", {style: styles, className: 'cr-page'}, React.createElement(PageDescription_1.default, null), React.createElement(Tasks_1.default, null), React.createElement(TasksComplete_1.default, null)));
    };
    return Page;
}(React.Component));
