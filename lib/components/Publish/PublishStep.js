...
function publishStep(index, type, field, click) {
    ...
    return (React.createElement(Stepper_1.Step, {key: index, completed: false}, React.createElement(Stepper_1.StepButton, {icon: icon, onClick: click}, field.name), React.createElement(Stepper_1.StepContent, null, React.createElement("p", null, "\"", field.name, "\" ", field.msg), React.createElement("p", null, "Example:"), React.createElement(core_coderoad_1.CodeBlock, {lang: 'js'}, "{\n  \"" + field.name + "\": " + field.example + "\n}"))));
}
