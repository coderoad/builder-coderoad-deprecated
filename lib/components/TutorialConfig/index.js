    ...
    TutorialConfig.prototype.render = function () {
        ...
        return (React.createElement(Card_1.Card, {style: styles.card}, 
            ...
            React.createElement("form", {onSubmit: handleSubmit(this.onSubmit.bind(this))}, 
                ...
                React.createElement(RaisedButton_1.default, {type: 'submit', style: styles.button, label: 'Save', primary: true, disabled: invalid, tabIndex: '4'}), 
                React.createElement(RaisedButton_1.default, {style: styles.button, label: 'Continue', secondary: true, disabled: invalid, onTouchTap: this.props.routeToPage.bind(this), tabIndex: '5'}))));
    };
