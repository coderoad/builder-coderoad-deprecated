...
exports.default = redux_1.combineReducers({
    ...
    packageJson: package_json_1.reducer, page: page_1.page, pagePosition: page_1.pagePosition, route: route_1.reducer, tasks: page_1.tasks,
    tutorial: tutorial_1.reducer, taskTests: page_1.taskTests, windowToggle: window_1.reducer
});
